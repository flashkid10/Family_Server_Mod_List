...
<table>
  ...
  <tr>
    <td>Pehkui</td>
    <td>This mod allows for most entities to have their size changed, either enlarging or shrinking them. (ie... extraorigins)</td>
  </tr>
  <tr>
    <td>FallingTree</td>
    <td>
  ...
  <tr>
    <td>Fat Experience Orbs</td>
    <td>This mod makes it so that nearby experience orbs merge together, when installed on the client this mod allows experience orbs to merge in single player. When installed on a dedicated server no client is required to have the mod.</td>
  </tr>
  <tr>
    <td>WorldEdit</td>
    <td><b>A Minecraft Map Editor... that runs in-game!</b> With selections, schematics, copy and paste, brushes, and scripting. Use it in creative, or use it temporarily in survival.</td>
  </tr>
  <tr>
    <td>Fabric-Discord Link</td>
    <td>A mod to link Minecraft and Discord chats for Fabric, This mod is server side only.</td>
  </tr>
  <tr>
...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      [❌] <i>No Food</i> - Unable to eat normal food; needs the "Flowery" power to regain hunger<br><br>
